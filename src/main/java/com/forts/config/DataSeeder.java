...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        logger.info("Checking/Seeding fort data...");

        // 1. Raigad
        createOrUpdateFort("Raigad Fort", "Raigad District", "Hill Fort",
        ...
        // 2. Shivneri
        createOrUpdateFort("Shivneri Fort", "Pune District", "Hill Fort",
        ...
        // 3. Pratapgad
        createOrUpdateFort("Pratapgad Fort", "Satara District", "Hill Fort",
        ...
        // 4. Sindhudurg
        createOrUpdateFort("Sindhudurg Fort", "Sindhudurg District", "Sea Fort",
        ...
        // 5. Torana
        createOrUpdateFort("Torna Fort", "Pune District", "Hill Fort",
        ...
        // 6. Harihar
        createOrUpdateFort("Harihar Fort", "Nashik District", "Hill Fort",
        ...
        // 7. Purandar
        createOrUpdateFort("Purandar Fort", "Pune District", "Hill Fort",
        ...
        // 8. Rajgad
        createOrUpdateFort("Rajgad Fort", "Pune District", "Hill Fort",
    ...
    private void createOrUpdateFort(String name, String location, String type, String description, String history, String galleryImages, String mainImage, List<String> imagePaths) {
        List<Fort> existing = fortRepository.findByNameContainingIgnoreCaseOrLocationContainingIgnoreCase(name, name);
        Fort fort;
        if (!existing.isEmpty()) {
            fort = existing.get(0);
            logger.info("Updating existing fort: {}", name);
        } else {
            fort = new Fort();
            logger.info("Creating new fort: {}", name);
        }
        ...
        // Update images
        if (fort.getImages() != null) {
            fort.getImages().clear();
        } else {
            fort.setImages(new ArrayList<>());
        }

        for (String path : imagePaths) {
            fort.getImages().add(new FortImage(fort, path));
        }
